...
public class NumberLiteralImpl extends ExpressionImpl implements NumberLiteral
{
  ...
  {
    return ArithmeticsPackage.Literals.NUMBER_LITERAL;
  }
  ...
  public void setValue(BigDecimal newValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ArithmeticsPackage.NUMBER_LITERAL__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ArithmeticsPackage.NUMBER_LITERAL__VALUE:
        return getValue();
    }
