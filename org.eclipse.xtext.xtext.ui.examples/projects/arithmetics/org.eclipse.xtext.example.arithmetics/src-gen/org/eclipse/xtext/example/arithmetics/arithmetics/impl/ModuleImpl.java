...
public class ModuleImpl extends MinimalEObjectImpl.Container implements Module
{
  ...
  {
    return ArithmeticsPackage.Literals.MODULE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ArithmeticsPackage.MODULE__NAME, oldName, name));
  }
  ...
  public EList<Import> getImports()
  {
    if (imports == null)
    {
      imports = new EObjectContainmentEList<Import>(Import.class, this, ArithmeticsPackage.MODULE__IMPORTS);
    }
    return imports;
  }
  ...
  public EList<Statement> getStatements()
  {
    if (statements == null)
    {
      statements = new EObjectContainmentEList<Statement>(Statement.class, this, ArithmeticsPackage.MODULE__STATEMENTS);
    }
    return statements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ArithmeticsPackage.MODULE__IMPORTS:
        return ((InternalEList<?>)getImports()).basicRemove(otherEnd, msgs);
      case ArithmeticsPackage.MODULE__STATEMENTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ArithmeticsPackage.MODULE__NAME:
        return getName();
      case ArithmeticsPackage.MODULE__IMPORTS:
        return getImports();
      case ArithmeticsPackage.MODULE__STATEMENTS:
